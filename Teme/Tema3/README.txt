...
elem = 5 -> glob disco
elem = 6 -> tavan
elem = 7 -> perete stanga
elem = 8 -> perete dreapta
...
Parametrul 'mode' isi schimba valoarea la apasarea tastei 'O'.
Luminile de spotlight pot fi adaugate si in modurile 0 si 1 daca se apasa tasta P.
