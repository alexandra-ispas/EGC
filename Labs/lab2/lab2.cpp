...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(0, 0,  1), glm::vec3(0, 0.2, 1)),
            VertexFormat(glm::vec3(-1, -1,  0), glm::vec3(0.8, 1, 0)),
            VertexFormat(glm::vec3(0, -1,  0), glm::vec3(0, 1, 0)),
            VertexFormat(glm::vec3(-1, 0,  0), glm::vec3(0, 0.2, 1)),
            VertexFormat(glm::vec3(0, 0,  0), glm::vec3(1, 0, 0.2)),
        };
...

    {
        ...
        // Actually create the mesh from the data
        CreateMesh("tetrahedron_B", vertices, indices);
    }

    {
        ...
        CreateMesh("square_B", vertices, indices);
    }
}
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(2.f, 1, 0), glm::vec3(0.5f));

    RenderMesh(meshes["tetrahedron_B"], shaders["VertexColor"], glm::vec3(3.f, 0, 1), glm::vec3(1.f));

    RenderMesh(meshes["square_B"], shaders["VertexColor"], glm::vec3(4.f, 0, 1), glm::vec3(1.f));
