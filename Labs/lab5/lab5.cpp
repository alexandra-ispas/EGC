...
void Lab5::Update(float deltaTimeSeconds)
{
    ...
    {
        glm::mat4 modelMatrix = glm::mat4(1);
        modelMatrix = glm::rotate(modelMatrix, RADIANS(80), glm::vec3(0, 1, 1));
        modelMatrix = glm::translate(modelMatrix, glm::vec3(4, 0.5f, 2));
    ...
    {
        glm::mat4 modelMatrix = glm::mat4(1);
        modelMatrix = glm::rotate(modelMatrix, RADIANS(145), glm::vec3(0, 1, 1));
        modelMatrix = glm::translate(modelMatrix, glm::vec3(1, 3.f, 2));
