...
void Lab9::Update(float deltaTimeSeconds)
{
    ...
    // Why does this happen? How can you solve it?
    {
        ...
        RenderSimpleMesh(meshes["sphere"], shaders["LabShader"], modelMatrix, true, mapTextures["earth"], mapTextures["random"]);
    }

    {
        ...
        RenderSimpleMesh(meshes["box"], shaders["LabShader"], modelMatrix, false , mapTextures["crate"], NULL);
    }

    {
        ...
        RenderSimpleMesh(meshes["box"], shaders["LabShader"], modelMatrix, false, mapTextures["random"], NULL);
    }

    {
        ...
        RenderSimpleMesh(meshes["square"], shaders["LabShader"], modelMatrix, false, mapTextures["grass"], NULL);
    }

    {
        ...
        RenderSimpleMesh(meshes["bamboo"], shaders["LabShader"], modelMatrix, false, mapTextures["bamboo"], NULL);
    }

    {
        glm::mat4 modelMatrix = glm::mat4(1);
        modelMatrix = glm::translate(modelMatrix, glm::vec3(3.0f, 0.5f, .0f));
        modelMatrix = glm::scale(modelMatrix, glm::vec3(1.f));
        RenderSimpleMesh(meshes["square"], shaders["LabShader"], modelMatrix, false , mapTextures["grass"], mapTextures["earth"]);
    }
}
...
void Lab9::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix, bool use_time,
    Texture2D* texture1, Texture2D* texture2)
{
    ...
    glUniform1i(glGetUniformLocation(shader->program, "mix_texture"), (texture1 && texture2));
    ...
    glUniform1i(glGetUniformLocation(shader->GetProgramID(), "use_time"), use_time ? 1 : 0);
