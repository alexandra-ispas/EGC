...
void main()
{
    ...
    vec3 world_normal = normalize(vec3 (Model * vec4 (normalize(v_normal), 0)));
    ...
    float light = ambient_light + 1 / pow(distance(light_position, world_position), 2) * (diffuse_light + specular_light);
